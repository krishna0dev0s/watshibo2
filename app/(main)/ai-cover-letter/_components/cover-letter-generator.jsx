      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-8">
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2 rounded-md group hover:bg-white/8 transition-all duration-300"
          >
            <ArrowLeft className="h-4 w-4 text-muted-foreground transition-transform duration-300 group-hover:-translate-x-1" />
            <span className="text-sm bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-violet-400 font-medium">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight metallic-text mb-4">
            Create Cover Letter
            <span className="block text-2xl md:text-3xl font-semibold text-muted-foreground mt-2">AI-Powered Writer</span>
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl font-medium max-w-3xl mx-auto text-gray-100">
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="bg-card/30 border border-white/10 backdrop-blur-sm shadow-xl">
            <CardHeader>
